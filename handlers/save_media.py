...
async def SaveBatchMediaInChannel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Akfilestolinkbot_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("⭕ Channel ⭕", url="https://t.me/Bull4movies"),
                  InlineKeyboardButton("⭕ Support ⭕", url="https://t.me/request_your_choice")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Akfilestolinkbot_{str_to_b64(file_er_id)}"
        await editable.edit(
